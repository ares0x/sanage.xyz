...
| Brain 训练室 | [brain.sanage.xyz](https://brain.sanage.xyz) | 专注力 · 反应速度 · 注意力训练 |
| Liuyao 排盘室 | [liuyao.sanage.xyz](https://liuyao.sanage.xyz) | 六爻排盘 · 易学数理 |
...
npm run deploy     # 等同于：npm run build && wrangler pages deploy dist
```
